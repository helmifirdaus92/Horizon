...
import { buildXmlElement, parseXmlElement } from '../../../utils/xml';
...
export function parseGeneralLinkRawValue(value: string, renderedUrl: string, renderedText: string): GeneralLinkValue | null {
  if (!value) {
    return null;
  }
