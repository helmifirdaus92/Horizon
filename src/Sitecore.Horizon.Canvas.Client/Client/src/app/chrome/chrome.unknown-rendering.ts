...
export class UnknownRenderingChrome extends Chrome {
  constructor(
    chromeId: string,
  ...
  getChromeInfo(): RenderingChromeInfo {
    throw new Error(`Can't get chrome info for unknown rendering chrome with instance id ${this.renderingInstanceId}`);
  }
  select(): void {}
  sortMoveUp?(): void {}
  sortMoveDown?(): void {}
