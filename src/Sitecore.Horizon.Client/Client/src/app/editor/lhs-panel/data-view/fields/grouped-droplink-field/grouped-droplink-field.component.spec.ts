...
import { of } from 'rxjs';
import { GroupedDroplinkFieldComponent } from './grouped-droplink-field.component';

describe(GroupedDroplinkFieldComponent.name, () => {
  let sut: GroupedDroplinkFieldComponent;
  let fixture: ComponentFixture<GroupedDroplinkFieldComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [GroupedDroplinkFieldComponent],
      providers: [
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(GroupedDroplinkFieldComponent);
  ...
  it('should get grouped link items if field source is defined and droplist is toggled', async () => {
    sut.field = mockField();
    fixture.detectChanges();
    ...
    const categoryElement = fixture.debugElement.queryAll(By.css('.grouped-droplink-items .category'));
    const childElement = fixture.debugElement.queryAll(By.css('.grouped-droplink-items .children'));
  ...
  it('should emit selected item id as the rawValue', async () => {
    ...
    expect(sut.selectedValueChange.emit).toHaveBeenCalledWith({ rawValue: '{1234}' });
  });

  it('should not emit selected value if the selected item is the same as the current value', async () => {
    spyOn(sut.selectedValueChange, 'emit');
    sut.field = mockField();
    sut.currentValue = '{B039EBE1-5813-4243-81AE-EA55B2352D80}';
    fixture.detectChanges();
