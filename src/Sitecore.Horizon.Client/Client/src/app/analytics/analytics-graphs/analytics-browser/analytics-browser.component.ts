...
@Component({
  ...
  templateUrl: './analytics-browser.component.html',
  styleUrls: ['./analytics-browser.component.scss'],
})
export class AnalyticsBrowserComponent extends AnalyticsModeBase implements OnChanges {
