...
import { AnalyticsBrowserComponent } from './analytics-browser.component';

@Component({
  template: `<app-analytics-browser
    [chartData]="chartData"
...
describe(AnalyticsBrowserComponent.name, () => {
  let fixture: ComponentFixture<BrowserTestComponent>;
  let sut: AnalyticsBrowserComponent;
  let testComponent: BrowserTestComponent;
  let debugEl: DebugElement;

  const expectedChartData: ChartData[] = [
    {
      name: 'sessionsByDeviceHist',
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [AnalyticsBrowserComponent, BrowserTestComponent],
      imports: [
        ChartsModule,
        CardModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(BrowserTestComponent);
    testComponent = fixture.componentInstance;
    debugEl = fixture.debugElement;
    sut = debugEl.query(By.directive(AnalyticsBrowserComponent)).componentInstance;
  ...
  describe('analytics mode toggling', () => {
    ...
    it('should render Site Analytics translations if mode is not defined', () => {
      ...
      expect(headerCmpt!.tooltipText).toBe('ANALYTICS.SITE_ANALYTICS.DESCRIPTIONS.BROWSER');
    });
    ...
    it('should render Page Analytics translations if mode is `pageAnalytics`', () => {
      ...
      const headerCmpt = getSpdCardHeader(fixture);
      expect(headerCmpt!.tooltipText).toBe('ANALYTICS.PAGE_ANALYTICS.DESCRIPTIONS.BROWSER');
    });
  });
});
