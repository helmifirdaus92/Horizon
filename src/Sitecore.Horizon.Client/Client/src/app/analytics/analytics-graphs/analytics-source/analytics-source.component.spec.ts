...
import { AnalyticsSourceComponent } from './analytics-source.component';

@Component({
  template: `<app-analytics-source
    [chartData]="chartData"
...
describe(AnalyticsSourceComponent.name, () => {
  let fixture: ComponentFixture<SourceTestComponent>;
  let sut: AnalyticsSourceComponent;
  let testComponent: SourceTestComponent;
  let debugEl: DebugElement;

  const expectedChartData: ChartData[] = [
    {
      name: 'sessionsByRefererHist',
      series: getDefaultSiteAnalytics().sessionsByRefererHist.data.current,
    },
  ];
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [AnalyticsSourceComponent, SourceTestComponent],
      imports: [
        ChartsModule,
        CardModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SourceTestComponent);
    testComponent = fixture.componentInstance;
    debugEl = fixture.debugElement;
    sut = fixture.debugElement.query(By.directive(AnalyticsSourceComponent)).componentInstance;
  ...
  describe('HandleData()', () => {
    it('should handle the chartData WHEN property value changes', () => {
      testComponent.chartData = getDefaultSiteAnalytics().sessionsByRefererHist;
      fixture.detectChanges();
    ...
    it('should show empty data WHEN no data', () => {
      testComponent.chartData = getEmptySiteAnalytics().sessionsByRefererHist;
      fixture.detectChanges();
